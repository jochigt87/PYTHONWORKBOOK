...
"""
In the game of Scrabble™, each letter has points associated with it. The total
score of a word is the sum of the score of its letters. More common letters
...
A Scrabble™ board includes some squares that multiply the value of a letter of
the value of an entire word. We will ignore these squares in this exercise.
"""
