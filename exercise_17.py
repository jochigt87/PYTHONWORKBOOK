...
The total amount of energy required to raise m grams of a material by 𝚫T
...
Hint: The specific heat capacity of water is 4.186 j/g℃ . Because water has a
desinsity of 1.0 gram per millitre, you can use grams and millitres
...
Joules. In this exercise, you should assume that electricity costs 8.9 cents
per kilowatt-hour. Use your program to compute the cost of boiling water for a
cup of coffee.
